...
export function CloudIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round">
      <path d="M17.5 19c2.5 0 4.5-2 4.5-4.5 0-2.3-1.7-4.2-3.9-4.5C17.6 6.3 14.8 4 11.5 4 8.7 4 6.3 5.7 5.2 8.2 2.8 8.7 1 10.8 1 13.5 1 16.5 3.5 19 6.5 19" />
    </svg>
  );
}
...
export function LayersIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="m2.6 11l8.58 3.91a2 2 0 0 0 1.66 0L21.4 11" />
      <path d="m2.6 15.5l8.58 3.91a2 2 0 0 0 1.66 0L21.4 15.5" />
    </svg>
  );
}
...
export function PackageIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round">
      <path d="m16.5 9.4-7.1-3.7a1 1 0 0 0-1.3.5l-7.1 14a1 1 0 0 0 .5 1.3l7.1 3.7a1 1 0 0 0 1.3-.5l7.1-14a1 1 0 0 0-.5-1.3Z" />
      <path d="m7 21 10-5" />
      <path d="M15.7 8.7 9 6.1" />
    </svg>
  );
}
...
export function LogoIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M4 8v11a2 2 0 0 0 2 2h10" opacity={0.3} />
      <path d="M8 5v11a2 2 0 0 0 2 2h10" opacity={0.6} />
      {/* Main Sheet */}
      <path d="M12 2v14a2 2 0 0 0 2 2h7a1 1 0 0 0 1-1V5.5L18.5 2H12z" />
      <path d="M18.5 2v3.5H22" />
      {/* Integrated Checkmark - Always High Visibility */}
      <path d="M14 11l2 2 4-4" strokeWidth={2.5} />
    </svg>
  );
}
